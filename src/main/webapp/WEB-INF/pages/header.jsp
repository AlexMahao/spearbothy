...
<script type="text/javascript">
	 $("document").ready(function(){
		...
		if(user==null){
			$(".header_login").html("<a href='ui_login'>登陆</a><label>|</label> <a href='ui_register'>注册</a>")
		}else{
			$(".header_login").html("<span>欢迎 "+user.name+"</span><label>|</label><a href='javascript:toedit()'>写文章</a><label>|</label><a href='javascript:'>个人信息</a><label>|</label><a href='javascript:exit()'>退出登陆</a>");
		}
	})
